...
$(document).ready(function(){
	...
	var tb1 = '<div class="vertical-gap"><table class="table table-responsive table-bordered "><thead><tr><th>Sr No. </th><th>Chỉ số phát triển</th><th>Tỉ lệ(in %)</th><th>Kết quả chuẩn đoán</th></tr></thead><tbody>';
	var tb2 = '</tbody></table></div>';
 	for(key in json){

		str += '<tr><td>'+i+'</td>'+'<td>'+'Trẻ nhỏ dưới 12 tuổi'+'</td>'+'<td>'+json[key].toFixed(2)+'</td>';
	    var danger = '<td class="text-danger">Chậm phát triển</td>';
	    var normal = '<td class="text-success">Phát triển bình thường</td>';
	    if(json[key] > 50)
	        str += danger;
	    else
	        str += normal;
