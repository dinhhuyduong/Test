							...
							<input id="login-password" type="password" class="form-control" name="password" placeholder="Mật khẩu" required>
	                                <div style="margin-top:10px" class="form-group">
	                                    <div class="col-sm-12 controls">
	                                      <button type="submit" id="btn-login" href="#" class="btn btn-info" style ="color: white; border: 3px solid indigo; background-color: blueviolet;">Đăng nhập</button>
	                                    </div>
	                                </div>
	                                <div class="form-group">
	                                    <div class="col-md-12 control">
	                                        ...
	                                        <a href="#" onClick="$('#loginbox').hide(); $('#signupbox').show()">
	                                           <h5 style ="color: white; border: 3px solid darkgreen; padding:4px; margin-left:20%; margin-right:20%; background-color: forestgreen;">Đăng ký</h5>
	                                        </a>
	                                        </div>
	                                    </div>
	                                </div>
	        ...
	        <form id="signupform" class="form-horizontal" role="form" action="../php/patientsignup.php" method="post">
	                                ...
	                                <div id="signupalert" style="display:none" class="alert alert-danger">
	                                    ...
	                                    <span></span>
											...
											<br>
	                                    <div class="col-sm-12 controls">
	                                        <button type="submit" id="btn-signup" type="button" class="btn btn-info" style ="color: white; border: 3px solid indigo; background-color: blueviolet;">Đăng ký</button>
	                                    </div>
