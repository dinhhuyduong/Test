...
<body style="background-color: skyblue;">
	...
	<div class= "inside2">
				<div class="alert alert-info">
							...
							<?php if(!isset($_SESSION['demail'])) header('location:index.php'); ?>
		...
		<div class="jumbotron" style="background-color: transparent; border: 2px solid black;">
			...
			<div class="row">
				<div class="dname col-md-2 "> <!-- col-md-offset-2 -->
					<input type="text" name="dname" placeholder="Name" class="form-control input-group-lg " id="dname" autofocus>
				</div>
